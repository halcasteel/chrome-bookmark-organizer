...
CREATE INDEX idx_a2a_tasks_type ON a2a_tasks (type);
CREATE INDEX idx_a2a_tasks_user_id ON a2a_tasks (user_id);
CREATE INDEX idx_a2a_tasks_created ON a2a_tasks (created);
CREATE INDEX idx_a2a_tasks_workflow_type ON a2a_tasks (workflow_type);
...
-- Create indexes for a2a_artifacts
CREATE INDEX idx_a2a_artifacts_task_id ON a2a_artifacts (task_id);
CREATE INDEX idx_a2a_artifacts_agent_type ON a2a_artifacts (agent_type);
CREATE INDEX idx_a2a_artifacts_type ON a2a_artifacts (type);
CREATE INDEX idx_a2a_artifacts_created ON a2a_artifacts (created);
...
CREATE INDEX idx_a2a_messages_agent_type ON a2a_messages (agent_type);
CREATE INDEX idx_a2a_messages_type ON a2a_messages (type);
CREATE INDEX idx_a2a_messages_timestamp ON a2a_messages (timestamp);
...
-- Grant permissions to admin user (the one we're using)
GRANT ALL PRIVILEGES ON TABLE a2a_tasks TO admin;
GRANT ALL PRIVILEGES ON TABLE a2a_artifacts TO admin;
GRANT ALL PRIVILEGES ON TABLE a2a_messages TO admin;
GRANT ALL PRIVILEGES ON TABLE a2a_agent_capabilities TO admin;
GRANT SELECT ON v_active_tasks TO admin;
GRANT SELECT ON v_task_history TO admin;  
GRANT SELECT ON v_agent_performance TO admin;