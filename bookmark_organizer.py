...
class BookmarkOrganizer:
    ...
    def deduplicate_bookmarks(self):
        """Remove duplicate bookmarks based on normalized URLs"""
        seen_urls = {}
        ...
        for bookmark in self.bookmarks:
            ...
            if normalized_url in seen_urls:
                # Keep the bookmark with more information or newer date
    ...
    def generate_readable_summary(self):
        ...
        with open(summary_path, 'w', encoding='utf-8') as f:
            f.write("BOOKMARK ORGANIZATION SUMMARY\n")
            f.write("=" * 50 + "\n\n")
...
if __name__ == "__main__":
    organizer = BookmarkOrganizer(
        ...
        "/home/halcasteel/BOOKMARKS/ORGANIZED"
    )
